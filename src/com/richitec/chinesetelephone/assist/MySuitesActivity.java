...
public class MySuitesActivity extends NavigationActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listView = (ExpandableListView) findViewById(R.id.my_suites_listview);
	...
	public void refreshSuites() {
		...
		HttpUtils.postSignatureRequest(getString(R.string.server_url)
				+ getString(R.string.getSuites_url),
				PostRequestFormat.URLENCODED, params, null,
				HttpRequestType.ASYNCHRONOUS, onFinishedGetSuites);
	}
	...
	private OnHttpRequestListener onFinishedGetSuites = new OnHttpRequestListener() {
		...
		public void onFailed(HttpResponseResult responseResult) {
			Log.d(SystemConstants.TAG, "onFinishedGetSuites status: "
					+ responseResult.getStatusCode() + " text: "
					+ responseResult.getResponseText());
			dismissDlg();
			MyToast.show(MySuitesActivity.this, R.string.get_suite_failed,
					Toast.LENGTH_SHORT);
